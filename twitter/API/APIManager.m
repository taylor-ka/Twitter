...
static NSString * const consumerKey = @"1EAXg5Dqsfw5EhQxGUHEY5I4A";
static NSString * const consumerSecret = @"o18gKojuwQlvkcFejUBOF8LIGdh1O3u8czkTkQqKQ3G04YvDxZ";
...
- (void)getHomeTimelineWithCompletion:(void(^)(NSMutableArray *tweets, NSError *error))completion {
   ...
   parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, NSArray *  _Nullable tweetDictionaries) {
       ...
       if (data != nil) {
           NSArray *tweetDictionaries = [NSKeyedUnarchiver unarchiveObjectWithData:data];
...
// Make POST request
- (void)postRequest:(NSString *)urlString parameters:(NSDictionary *)parameters completion:(void (^)(Tweet *, NSError *))completion{
    // Post request
